...
<ul>
  ...
  <li><strong>NAT (ترجمة عنوان الشبكة):</strong> يسمح لشبكة خاصة باستخدام عنوان IP عام واحد للاتصال بالإنترنت. يترجم موجه NAT بين مجموعات IP/المنفذ خاصة داخلية و IP/المنفذ عامة خارجية. هذا يوفر عناوين IP العامة ويحسن الأمان.</li>
</ul>
...
<p>للانتقال من IPv4 إلى IPv6، نستخدم <strong>الأنفاق (Tunneling)</strong>: يتم تغليف حزمة IPv6 داخل حزمة IPv4 كحمولة للسفر عبر موجهات IPv4 فقط.</p>`
  ...
  mcq: [
    ...
    {
      id: 'cn-l8-q3',
      question: "[MID] Which protocol is typically used to dynamically assign an IP address to a host when it joins a network?",
      questionAr: "[MID] ما هو البروتوكول الذي يُستخدم عادةً لتعيين عنوان IP ديناميكيًا للمضيف عند انضمامه إلى الشبكة؟",
      difficulty: 'easy',
      isMidterm: true,
      answers: [
