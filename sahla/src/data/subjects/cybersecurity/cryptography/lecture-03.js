...
<ul>
  ...
  written: [
    ...
    },
    {
      ...
      modelAnswerAr: "تم استبدال DES لأن مفتاحه ذو 56 بت كان قصيرًا جدًا، مما جعل عرضة لهجمات القوة الغاشمة. في 1999 تم كسر DES في 22 ساعة فقط. البدائل تشمل: Triple DES (3DES) الذي يطبق DES ثلاث مرات بـ 2 أو 3 مفاتيح، وAES الذي يستخدم مفاتيح 128/192/256 بت وهو المعيار الحالي. كما ظهرت شفرات أخرى مثل IDEA وCAST وBlowfish.",
    },
    {
      id: 'crypto-l3-w3',
